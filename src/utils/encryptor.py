...
# in a single place (in weidr, beside Utils._get_external_drive_root) -- port
# these fallbacks there rather than leaving two copies to drift.
...
def key_store_dir(service_name: str) -> str:
    ...
    platform is user_data_dir()'s business. WEIDR_CACHE_DIR still wins, so a
...
KEY_BACKUP_DIR_ENV_VAR = "WEIDR_KEY_BACKUP_DIR"
